...
class FirstFragment : Fragment(), InventoryListAdapter.InventoryListInterface, SearchView.OnQueryTextListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val tagList1 = arrayListOf(tag1, tag2, tag3, tag4, tag5)
        val tagList2 = arrayListOf(tag2, tag4)
        val tagList3 = arrayListOf(tag1, tag2, tag5, tag4, tag1, tag2, tag5, tag4, tag1, tag2, tag5, tag4)
        val tagList4 = arrayListOf(tag1, tag2, tag3, tag4, tag5)
        val tagList5 = arrayListOf(tag2, tag4)
        val tagList6 = arrayListOf(tag1, tag2, tag5, tag4, tag1, tag2, tag5, tag4, tag1, tag2, tag5, tag4)
        val tagList7 = arrayListOf(tag1, tag2, tag3, tag4, tag5)
        val tagList8 = arrayListOf(tag2, tag4)
        val tagList9 = arrayListOf(tag1, tag2, tag5, tag4, tag1, tag2, tag5, tag4, tag1, tag2, tag5, tag4)
        ...
        val item4 = InventoryItem("testandMore", true,1, tagList4)
        val item5 = InventoryItem("TestAny", true,1, tagList5)
        val item6 = InventoryItem("AnyTest", true,1, tagList6)
        val item7 = InventoryItem("TEST7", true,1, tagList7)
        val item8 = InventoryItem("teSt8", true,1, tagList8)
        val item9 = InventoryItem("testingAnyMoreand9", true,1, tagList9)

        itemList = arrayListOf(item1, item2, item3, item4, item5, item6, item7, item8, item9)
        for (i in itemList){
